...
For each SOFA run, all the files are created into a `.sofa_runs` folder in the platform-specific temporary directory thanks to [tempfile](https://docs.python.org/3/library/tempfile.html#tempfile.gettempdir):
...
For example on Windows, the files are created here: 

    C:\Users\<USER>>\AppData\Local\Temp\.sofa_runs\run_2025-12-15-14-33

⚠️ Since the files are created in a temporary location, they will be erased after a reboot of the computer. Remember to copy the folder you want to keep into another locaiton.
...
### Example of output scene_config.toml

Here is the TOML file generated by the the scene of the example.

```toml
frames = 2500
frequency = 1
[[objects]]
mesh = "C:/Users/hanae/Dev/Sofa.BlenderToolbox/example/meshes/saladBowl"
type = "static"
name = "SaladBowl"
scale = [ 200.0, 200.0, 70.0,]
translation = [ 35.0, -25.0, 0.0,]
rotation = [ -90.0, 0.0, 0.0,]

[[objects]]
mesh = "C:/Users/hanae/AppData/Local/Temp/.sofa_runs/run_2025-12-15-14-33/Beam"
type = "deformable"
name = "Beam"
scale = [ 1.0, 1.0, 1.0,]
translation = [ 0.0, 0.0, 0.0,]
rotation = [ 0.0, 0.0, 0.0,]
monitor = "C:\\Users\\hanae\\AppData\\Local\\Temp\\.sofa_runs\\run_2025-12-15-14-33\\Beam_x.txt"

[[objects]]
mesh = "C:/Users/hanae/AppData/Local/Temp/.sofa_runs/run_2025-12-15-14-33/d20"
type = "rigid"
name = "d20"
scale = [ 1.0, 1.0, 1.0,]
translation = [ 0.0, 0.0, 0.0,]
rotation = [ 0.0, 0.0, 0.0,]
monitor = "C:\\Users\\hanae\\AppData\\Local\\Temp\\.sofa_runs\\run_2025-12-15-14-33\\d20_x.txt"

[[objects]]
mesh = "C:/Users/hanae/Dev/Sofa.BlenderToolbox/example/meshes/icosahedronFine"
type = "deformable"
name = "JellyD20"
scale = [ 1.0, 1.0, 1.0,]
translation = [ 0.0, 0.0, 0.0,]
rotation = [ 0.0, 0.0, 0.0,]
monitor = "C:\\Users\\hanae\\AppData\\Local\\Temp\\.sofa_runs\\run_2025-12-15-14-33\\JellyD20_x.txt"
```
</details>
...
## Usage
1. Open a terminal where the `blender_importer.py` file is or copy the path
2. Run from shell where Blender's executable is accessible:
    ```bash
    blender [preconfigured_scene.blend] --python blender_importer.py -- path/to/scene_config.toml
    ```
